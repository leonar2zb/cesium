  ...
  if (isOverlay) {
    return (
      <div className="min-h-screen w-full bg-gray-50 text-gray-900">
        ...
        {open && (
          <div className="fixed top-16 left-4 z-[10040] w-72 max-w-[85vw] max-h-[80vh] overflow-y-auto rounded-lg border border-white/20 bg-black/70 text-white shadow-2xl backdrop-blur-sm">
